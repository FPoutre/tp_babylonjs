...
export default class T70 {
    ...
    constructor(userName, scene, soundManager) {
        ...
        this.speed = 1;
        this.idleTraverseSpeed = 0.01;
        this.turretTraverseSpeed = 0.0075; 

        let scaling = 2.5;

        this.cannonDirection = new BABYLON.Vector3(0, 0, 0);

        BABYLON.SceneLoader.ImportMesh(null, "models/Tank/", "t70Hull.glb", scene, (newMeshes, particleSystems, skeletons) => {
        ...
        BABYLON.SceneLoader.ImportMesh(null, "models/Tank/", "t70Turret.glb", scene, (newMeshes, particleSystems, skeletons) => {
        ...
        // Physics
        this.hitbox = BABYLON.MeshBuilder.CreateBox(this.userName + '_hitbox', {width:30, height:27.5, size:40}, scene);
    ...
    move(inputStates) {
        if (this.hull) {
            ...
            this.hull.position = new BABYLON.Vector3(this.physicsRoot.position.x, this.physicsRoot.position.y, this.physicsRoot.position.z);
            this.turret.position = new BABYLON.Vector3(this.physicsRoot.position.x, this.physicsRoot.position.y, this.physicsRoot.position.z);
            this.nametag.position = new BABYLON.Vector3(this.physicsRoot.position.x, this.physicsRoot.position.y + 35, this.physicsRoot.position.z);
    ...
    shootMainGun() {
        ...
        new Shell('HE', this.cannonDirection, new BABYLON.Vector3(pos.x, pos.y + 150, pos.z), this.scene);
    }
